...
def main(unused_args):
    ...
    modelname = 'wiki256_10M_ACT3_rnn'
    print(modelname)
    ...
    for ite in [0]:
        ...
        with tf.Graph().as_default(), tf.Session() as session:
            ...
            with tf.variable_scope('model', reuse=None, initializer=initialiser):
                ...
                m = seq2seqModel(config, is_training=True)
            ...
            model_trained=os.path.join(FLAGS.data_path, 'ACTmodel/wiki256_10M_ACT2_rnn.pkl')
            ...
            for i in range(29,config.max_max_epoch):
                ...
                if i==100:
                    saveload.main(model_100_path, session)
...
if __name__ == '__main__':
    ...
    flags.DEFINE_string("data_path", '/home/.../.../', "data_path")
